...
let App = class {
  ...
  componentDidLoad() {
    ...
    {
      rIC( /*#__PURE__*/(0,_Users_gregorywoolery_Documents_Personal_zBank_zBank_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
let Footer = class {
  constructor(hostRef) {
    ...
    this.setupFadeFooter = /*#__PURE__*/function () {
      var _ref2 = (0,_Users_gregorywoolery_Documents_Personal_zBank_zBank_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl) {
        if (!contentEl) {
...
let Header = class {
  constructor(hostRef) {
    ...
    this.setupFadeHeader = /*#__PURE__*/function () {
      var _ref3 = (0,_Users_gregorywoolery_Documents_Personal_zBank_zBank_client_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl, condenseHeader) {
        if (!contentEl) {
